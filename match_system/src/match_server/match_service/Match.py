...
class Client(Iface):
    ...
    def addPlayer(self, score, uuid, username, photo, channel_name):
        ...
        """
        self.send_addPlayer(score, uuid, username, photo, channel_name)
        return self.recv_addPlayer()

    def send_addPlayer(self, score, uuid, username, photo, channel_name):
...
class Processor(Iface, TProcessor):
    ...
    def process_addPlayer(self, seqid, iprot, oprot):
        ...
        result = addPlayer_result()
        try:
            result.success = self._handler.addPlayer(args.score, args.uuid, args.username, args.photo, args.channel_name)
        ...
        oprot.writeMessageBegin("addPlayer", msg_type, seqid)
        result.write(oprot)
        oprot.writeMessageEnd()
        oprot.trans.flush()
...
all_structs.append(addPlayer_args)
addPlayer_args.thrift_spec = (
    None,  # 0
...
class addPlayer_result(object):
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(addPlayer_result)
addPlayer_result.thrift_spec = (
